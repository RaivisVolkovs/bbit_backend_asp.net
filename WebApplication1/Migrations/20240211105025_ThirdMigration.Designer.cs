...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20240211105025_ThirdMigration")]
            ...
            modelBuilder.Entity("WebApplication1.Models.Dzivoklis", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ba0b4d1d-3bd9-4bb3-947e-a7fc74ff5912"),
                            DzīvojamāPlatība = 60.5,
                            IedzīvotājuSkaits = 2,
                            IstabuSkaits = 3,
                            MājaId = new Guid("632b7117-1a7e-461e-8482-0cdea90a66a5"),
                            Numurs = "1",
                            PilnaPlatība = 80.5,
                            Stāvs = 1
                        },
                        new
                        {
                            Id = new Guid("573bfecf-fe2f-418a-b23a-29ed9d219678"),
                            DzīvojamāPlatība = 75.0,
                            IedzīvotājuSkaits = 3,
                            IstabuSkaits = 4,
                            MājaId = new Guid("0f1847de-8026-44ef-9898-dbba2b2849ac"),
                            Numurs = "2",
                            PilnaPlatība = 100.0,
                            Stāvs = 2
                        },
                        new
                        {
                            Id = new Guid("f836afd7-3ec3-4105-913a-111b571f4744"),
                        ...
                        new
                        {
                            Id = new Guid("3ab1e8a7-5b4f-44b3-bf3d-96ef7c1df486"),
                        ...
                        new
                        {
                            Id = new Guid("73ad0164-6dc8-4b13-a037-c7ce37ec613d"),
            ...
            modelBuilder.Entity("WebApplication1.Models.Iedzivotajs", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("30b71543-ba76-4c6a-8816-5f4b2dfe937e"),
                            DzimšanasDatums = new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DzīvoklisId = new Guid("ba0b4d1d-3bd9-4bb3-947e-a7fc74ff5912"),
                        ...
                        new
                        {
                            Id = new Guid("1f7c0966-0790-42fe-89b1-7ec8f2c87977"),
                        ...
                        new
                        {
                            Id = new Guid("3543191c-e03a-4b20-815d-c2060e984c59"),
                            DzimšanasDatums = new DateTime(1990, 3, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DzīvoklisId = new Guid("f836afd7-3ec3-4105-913a-111b571f4744"),
                        ...
                        new
                        {
                            Id = new Guid("8bdc02b5-f820-465a-84eb-2220a1e2af67"),
                            DzimšanasDatums = new DateTime(1992, 4, 4, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DzīvoklisId = new Guid("3ab1e8a7-5b4f-44b3-bf3d-96ef7c1df486"),
                            Email = "liga@inbox.lv",
            ...
            modelBuilder.Entity("WebApplication1.Models.Maja", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("632b7117-1a7e-461e-8482-0cdea90a66a5"),
                            Iela = "Brīvības iela",
                            Numurs = 1,
                        ...
                        new
                        {
                            Id = new Guid("0f1847de-8026-44ef-9898-dbba2b2849ac"),
                            Iela = "Lāčplēša iela",
                            Numurs = 2,
