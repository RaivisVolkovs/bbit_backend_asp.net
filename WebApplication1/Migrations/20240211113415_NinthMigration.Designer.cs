...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20240211113415_NinthMigration")]
            ...
            modelBuilder.Entity("WebApplication1.Models.Dzivoklis", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8f2d00b6-25f5-404f-9b4c-f96f01fcdea9"),
                            DzīvojamāPlatība = 60.5,
                            IedzīvotājuSkaits = 2,
                            IstabuSkaits = 3,
                            MājaId = new Guid("2d025f32-ecad-412e-9acc-620cab218976"),
                            Numurs = "1",
                            PilnaPlatība = 80.5,
                            Stāvs = 1
                        },
                        new
                        {
                            Id = new Guid("52421b0d-6d68-4b33-9dde-76d720ada3e6"),
                            DzīvojamāPlatība = 75.0,
                            IedzīvotājuSkaits = 3,
                            IstabuSkaits = 4,
                            MājaId = new Guid("938af58b-fb1a-4f52-9ef4-78cc266e455d"),
                            Numurs = "2",
                            PilnaPlatība = 100.0,
                            Stāvs = 2
                        },
                        new
                        {
                            Id = new Guid("dbe69892-341a-4450-9eeb-d85998fccdf1"),
                        ...
                        new
                        {
                            Id = new Guid("98f8b5ca-cde2-4ad4-a252-64a3c56fd1ce"),
                        ...
                        new
                        {
                            Id = new Guid("48a657fb-c2e5-44f8-8a98-c2c9c48d1abe"),
            ...
            modelBuilder.Entity("WebApplication1.Models.DzivoklisIedzivotajs", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f2a0c174-0858-4603-80c5-c4366debb56c"),
                            DzivoklisId = new Guid("8f2d00b6-25f5-404f-9b4c-f96f01fcdea9"),
                            IedzivotajsId = new Guid("39fa67c2-35ff-4abe-9a53-dd08d48b5566"),
                            IsOwner = true
                        },
                        new
                        {
                            Id = new Guid("03b15a19-0319-4c43-9698-a527a75f9858"),
                            DzivoklisId = new Guid("8f2d00b6-25f5-404f-9b4c-f96f01fcdea9"),
                            IedzivotajsId = new Guid("ae7a5a57-87f6-4245-988b-985f772b6176"),
                            IsOwner = false
                        },
                        new
                        {
                            Id = new Guid("9d952995-ca43-4710-8ac6-cbdc1b682d5d"),
                            DzivoklisId = new Guid("52421b0d-6d68-4b33-9dde-76d720ada3e6"),
                            IedzivotajsId = new Guid("39fa67c2-35ff-4abe-9a53-dd08d48b5566"),
                            IsOwner = true
                        },
                        new
                        {
                            Id = new Guid("42627976-4310-49fc-9a4c-98374e563adc"),
                            DzivoklisId = new Guid("dbe69892-341a-4450-9eeb-d85998fccdf1"),
                            IedzivotajsId = new Guid("39fa67c2-35ff-4abe-9a53-dd08d48b5566"),
                            IsOwner = false
                        });
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.Iedzivotajs", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("39fa67c2-35ff-4abe-9a53-dd08d48b5566"),
                        ...
                        new
                        {
                            Id = new Guid("ae7a5a57-87f6-4245-988b-985f772b6176"),
                        ...
                        new
                        {
                            Id = new Guid("8872f6be-8b41-4688-b4c9-eaaaa3ddb7cc"),
                        ...
                        new
                        {
                            Id = new Guid("70900368-3e74-4ec4-869c-0f500e993909"),
            ...
            modelBuilder.Entity("WebApplication1.Models.Maja", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2d025f32-ecad-412e-9acc-620cab218976"),
                            Iela = "Brīvības iela",
                            Numurs = 1,
                        ...
                        new
                        {
                            Id = new Guid("938af58b-fb1a-4f52-9ef4-78cc266e455d"),
                            Iela = "Lāčplēša iela",
                            Numurs = 2,
