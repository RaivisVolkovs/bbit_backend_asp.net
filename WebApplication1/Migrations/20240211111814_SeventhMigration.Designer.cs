...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20240211111814_SeventhMigration")]
            ...
            modelBuilder.Entity("WebApplication1.Models.Dzivoklis", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("569ca6bf-e372-4d9c-adff-ece266fc511f"),
                            DzīvojamāPlatība = 60.5,
                            IedzīvotājuSkaits = 2,
                            IstabuSkaits = 3,
                            MājaId = new Guid("efe6ecaa-0c9d-4bc7-9b9c-70a980debeff"),
                            Numurs = "1",
                            PilnaPlatība = 80.5,
                            Stāvs = 1
                        },
                        new
                        {
                            Id = new Guid("20c95e7e-18fc-4493-95cc-946c449e0cfc"),
                            DzīvojamāPlatība = 75.0,
                            IedzīvotājuSkaits = 3,
                            IstabuSkaits = 4,
                            MājaId = new Guid("dcdbc434-bc28-4b8e-98b2-9b45aabe03bc"),
                            Numurs = "2",
                            PilnaPlatība = 100.0,
                            Stāvs = 2
                        },
                        new
                        {
                            Id = new Guid("cf2ca99c-1f42-47dc-b0cb-d2ee21c27ea0"),
                        ...
                        new
                        {
                            Id = new Guid("3493820b-d72c-4fb9-9aee-82999b919422"),
                        ...
                        new
                        {
                            Id = new Guid("79b3023e-dad5-4f13-a8b5-7becd50ee417"),
            ...
            modelBuilder.Entity("WebApplication1.Models.Iedzivotajs", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("984bf48f-c61c-4220-ab67-470540e9fd4e"),
                        ...
                        new
                        {
                            Id = new Guid("ec624523-20f3-428b-b34f-c57ffb719d19"),
                        ...
                        new
                        {
                            Id = new Guid("6e116019-c4a2-45e1-9c0d-3e131ed4fd0c"),
                        ...
                        new
                        {
                            Id = new Guid("e475dd75-f340-43e1-8f8a-eb2e98b6ee61"),
            ...
            modelBuilder.Entity("WebApplication1.Models.Maja", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("efe6ecaa-0c9d-4bc7-9b9c-70a980debeff"),
                            Iela = "Brīvības iela",
                            Numurs = 1,
                        ...
                        new
                        {
                            Id = new Guid("dcdbc434-bc28-4b8e-98b2-9b45aabe03bc"),
                            Iela = "Lāčplēša iela",
                            Numurs = 2,
